    ...
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <Link href="/admin/products">
          <Button className="rounded-full">Volver a Productos</Button>
        </Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-serif text-foreground">Editar Producto</h1>
            ...
            {variants.map((variant, index) => (
              ...
              >
                <div className="flex-1">
                  ...
                  <Select
                    value={variant.size}
                    onValueChange={(value) => updateVariantField(index, "size", value)}
                  >
